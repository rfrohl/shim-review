...
*******************************************************************************
Our internal build service isn't publicly available. The code is shim 16.0 + the patches
...
x86_64:
podman build --build-arg ARCHITECTURE=x86_64 -t sles_shim:16.0 .
aarch64:
podman build --build-arg ARCHITECTURE=aarch64 -t sles_shim:16.0 .
...
docker run --rm -it sles_shim:16.0 /bin/sh
...
*******************************************************************************
It launches grub, fwupdate and fwupd, nothing else

*******************************************************************************
### What kernel are you using? Which patches and configuration does it include to enforce Secure Boot?
*******************************************************************************
This shim is used on multiple products, each with their own kernel. This would be quite a long list here, but one example is:
5.14.21 +
